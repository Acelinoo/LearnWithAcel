...
import { vibeLevels } from "@/lib/vibeRoadmap";
...
const tools = [
  {
    name: "Cursor",
    tag: "AI Code Editor",
    desc: "VS Code versi AI. Bisa generate, edit, dan debug kode lewat chat. Ini senjata utamamu.",
  ...
  },
  {
    ...
    desc: "Untuk melihat hasil app-mu dan debugging. Tekan F12 untuk buka DevTools.",
  ...
  },
  {
    name: "GitHub Account",
    tag: "Code hosting",
    desc: "Tempat menyimpan kode dan deploy otomatis. Gratis. Buat akun di github.com.",
  ...
  },
  {
    name: "Vercel Account",
    tag: "Deployment",
    desc: "Publish app ke internet dalam 1 klik. Hubungkan ke GitHub, deploy otomatis tiap push.",
  ...
  },
  {
    name: "ChatGPT / Claude",
    tag: "AI Assistant",
    desc: "Untuk brainstorm, debugging, dan menulis prompt kompleks. Bisa pakai versi gratis.",
  ...
  },
  {
    name: "Node.js (LTS)",
    tag: "Runtime",
    desc: "Dibutuhkan untuk menjalankan project React/Next.js di lokal. Install versi LTS.",
...
export default function PersiapanVibePage() {
  const firstLesson = vibeLevels[0]?.lessons[0];
      ...
      <section className="container-page pt-12">
        ...
        <Reveal delay={0.15}>
          <p className="mt-5 max-w-2xl text-[15px] leading-relaxed text-muted">
            ...
            gratis, setup sekitar 15 menit, dan kamu langsung bisa mulai
            generate app pertamamu.
          </p>
        </Reveal>
            ...
            <div className="relative flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
              <div className="max-w-xl">
                ...
                <h3 className="mt-4 font-display text-2xl font-semibold tracking-tight sm:text-3xl">
                  Masuk ke Level 0 — Mindset & Orientation.
                </h3>
                <p className="mt-3 text-sm leading-relaxed text-muted">
                  Kita mulai dari memahami landscape AI coding, lalu langsung build.
                </p>
              </div>
              <div className="flex flex-col gap-3 sm:flex-row md:flex-col">
                <Link href="/roadmap/vibe" className="btn-primary">
                  Lihat Roadmap Vibe
                  <ArrowRight size={16} />
                </Link>
                <Link href="/pilih-jalur" className="btn-secondary">
                  Ganti jalur
                </Link>
              </div>
            </div>
